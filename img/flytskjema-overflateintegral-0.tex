...
\begin{tikzpicture}[node distance=2cm]
  ...
  \node (stop2) [startstop, fill=orange, below of=dec3, yshift=-0.5cm, xshift=1.43cm, align=left] {$\displaystyle\iint_R \F(\rr(u,v))\cdot \left( \diffp{\rr}{u} \times \diffp{\rr}{v} \right)\mathrm{d}(u,v)$};
