\documentclass[screen, aspectratio=43, serif, norsk]{beamer}
...
\tikzstyle{arrow} = [thick,->,>=stealth]
    ...
    \pgfkeys{/pgfplots/Trigonometric Style/.style={
...
\title[tinyurl.com/flerdim2020]{Flerdimhistorien på 90 minutter}
\subtitle{tinyurl.com/flerdim2020}
...
\begin{frame}\centerline{
  \begin{tikzpicture}[scale=0.75]
    \begin{axis}[ xbar=0pt, /pgf/bar shift=0pt,
...
\input{Introduksjon.tex}

% 14/20 Done


% Derivasjon
\input{Derivasjon.tex}              % Done
\input{Grenseverdier.tex}           % Done
\input{Gradient.tex}
\input{Epsilon-Delta.tex}           % Done
\input{Div-og-curl.tex}             % Done
\input{Kjerneregelen.tex}           % Done
\input{Taylor-approksimasjon.tex}   % Done
\input{Tangenter.tex}               % Done
\input{Kritiske-punkter.tex}        % Done
\input{Optimering.tex}

% Integrasjon
\input{Integrasjon.tex}             % Done
\input{Linjeintegral.tex}           % Done
\input{Konservative-vektorfelt.tex} % Done
\input{Dobbelintegraler.tex}        % Done
\input{Integrasjonsrekkefolge.tex}  % Done
\input{Trippelintegral.tex}
\input{Greens-teorem.tex}           % Done
\input{Overflateintegral.tex}       % Done
\input{Divergensteoremet.tex}
\input{Stokes-teorem.tex}
