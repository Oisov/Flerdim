 ...
 \begin{align*}
   ...
   \only<1-6>{& =
     \begin{vmatrix} \only<2>{\I} \only<3>{\circled{\I}} \only<6->{\I}
       ...
       & \only<2-4>{\cfrac{\partial}{\partial z}} \only<6->{\cfrac{\partial}{\partial z}}\\
    ...
    \end{vmatrix}}
        \only<7>{&}\only<3-7>{=\I \begin{vmatrix} \cfrac{\partial}{\partial y} & \cfrac{\partial f}{\partial z} \\
                  \cfrac{\partial}{\partial y} & \cfrac{\partial f}{\partial z} \end{vmatrix}}
        \only<4-7>{- \J \begin{vmatrix} \cfrac{\partial}{\partial x} & \cfrac{\partial f}{\partial z} \\
                  \cfrac{\partial}{\partial x} & \cfrac{\partial f}{\partial z} \end{vmatrix}}
